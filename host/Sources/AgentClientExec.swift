...
extension AgentClient {
  fileprivate static func makeInteractiveCommand(
    name: String,
    args: [String],
  ...
  fileprivate static func runInteractiveRequestProducer(
  ...
  fileprivate static func processExecResponse(
  ...
  fileprivate static func processExecStream(
  ...
  fileprivate static func streamStdin(to writer: RPCWriter<Darvm_ExecRequest>) async throws {
  ...
  fileprivate static func streamTerminalResizes(to writer: RPCWriter<Darvm_ExecRequest>) async throws {
